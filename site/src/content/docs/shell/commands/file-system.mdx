...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>rm [-r/-f] path</code></td><td>Remove file or directory; use <code>rm -i dir</code> for an interactive tree selector</td></tr>
    ...
    <tr><td><code>unblock [-a|--attributes-only] path</code></td><td>Clear delete-blocking attributes and terminate locking processes; use <code>-a</code> to preserve processes</td></tr>
